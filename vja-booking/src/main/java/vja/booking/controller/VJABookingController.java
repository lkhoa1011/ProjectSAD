...
@RestController
@RequestMapping("/")
public class VJABookingController {
	@Autowired
	...
	public Booking Ticket() {
		...
		List<Object> ticket = restTemplate.getForObject("http://ticket-vja/tickets/", List.class);
		tc.setTicket(ticket);
	...
	public Booking getTicket(@PathVariable final String ngaydi, @PathVariable final String ngayve , @PathVariable final String noidi ,@PathVariable final String noiden ,@PathVariable final String nguoilon,
		...
		String result = restTemplate.getForObject("http://ticket-vja/tickets/", String.class);
		Object obj ;
		try {
...
//	public Booking getBooking(@PathVariable String ngaydi,
//			@PathVariable final String ngayve , @PathVariable final String noidi ,
//			@PathVariable final String noiden ,@PathVariable final String nguoilon,
//			@PathVariable final String treem, @PathVariable final String embe) {
//		// create gallery object	
//		Booking booking = new Booking();
//		
//		// get list of available images 
//		List<Object> ve = restTemplate.getForObject("http://image-service/ticket/"
//				+ ngaydi + "/"
//				+ ngayve + "/"
//				+ noidi + "/"
//				+ noiden + "/"
